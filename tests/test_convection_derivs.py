"""
Test code for swft, checking actual heat transfer derivs.
...
def read_derivs():
    ...
    keys = ['p', 'v', 'rho']
    dUdH_fd = {key:(data1[key]-data0[key])/(cfg1['CH']-cfg0['CH']) for  key in keys}

    dUdH = read_solution_file("CHderivs-{}.bin".format(name0))
